...
const WaterSampleAccess = () => {
  ...
  return (
    <div className=" m-4 flex max-h-96 min-h-sm min-w-95 translate-x-8 flex-col justify-between rounded-md bg-gradient-to-tl from-loadBlue to-loadBlue/90 shadow-lg">
      <Link
        href="/"
